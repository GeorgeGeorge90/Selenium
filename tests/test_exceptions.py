...
class TestExceptions:
    ...
    def test_no_such_element_exception(self, driver):
        ...
        assert row_2_input_element.is_displayed(), "Row 2 should be displayed, but it's not"
    ...
    def test_element_not_interactable_exception(self, driver):
        ...
        save_button = driver.find_element(By.XPATH, "//div[@id='row2']/button[@name='Save']").click()
    ...
    def test_no_such_element_exception(self, driver):
        ...
        row_2_input_element = wait.until(ec.visibility_of_element_located(
            (By.XPATH, "//div[@id='row2']/input"))), "Failed waiting for Row 2 input to be visible"
